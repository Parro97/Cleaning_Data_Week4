...
setwd("C:/Users/crist/OneDrive/Escritorio/Curso R/Coursera/Cleaning_Data")
#download.file(fileurl,'./UCI HAR Dataset.zip', mode = 'wb')#, destfile="./Week3") #,destfile = "./Week3/Codebook.csv")
download.file(fileurl,destfile = './Final_Project/aa.zip')
unzip("Final_Project/aa.zip",exdir = "./Final_Project")
...
data.sub <- data[,c(1,2,mean_std.select + 2)]
...
write.table(x = data.tidy, file = "Final_Project/data_tidy.txt", row.names = FALSE)